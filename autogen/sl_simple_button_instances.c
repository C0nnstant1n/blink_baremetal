...
#include "sl_simple_button_SW1_config.h"

sl_simple_button_context_t simple_sw1_context = {
  .state = 0,
  .history = 0,
  .port = SL_SIMPLE_BUTTON_SW1_PORT,
  .pin = SL_SIMPLE_BUTTON_SW1_PIN,
  .mode = SL_SIMPLE_BUTTON_SW1_MODE,
};

const sl_button_t sl_button_sw1 = {
  .context = &simple_sw1_context,
...
{
  sl_button_init(&sl_button_sw1);
}

void sl_simple_button_poll_instances(void)
{
  sl_button_poll_step(&sl_button_sw1);
}
